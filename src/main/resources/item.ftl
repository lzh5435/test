						...
						<div class="search">
							<form action="" class="sui-form form-inline">
								...
								<div class="input-append">
									...
									<button ng-click="searchItem()"  class="sui-btn btn-xlarge btn-danger" type="button">搜索</button>
								</div>
							</form>
						</div>
						<div class="hotwords">
				...
				<div class="fl preview-wrap">
					...
					<div class="zoom">
						...
						<div id="preview" class="spec-preview">
							<span class="jqzoom">
								<#if (imagelist ? size > 0)>
								<img jqimg="${imagelist[0].imgUrl}" ng-src="${imagelist[0].imgUrl}"
							...
							<div class="items">
								<ul>
									<#list imagelist as item>
										<li><img ng-src="${item.imgUrl}" bimg="${item.imgUrl}" onmousemove="preview(this)" /></li>
									</#list>
								</ul>
							</div>
							<a class="next">&gt;</a>
